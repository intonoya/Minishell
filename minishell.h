...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/30 16:35:58 by intonoya          #+#    #+#             */
/*   Updated: 2023/03/30 16:36:01 by intonoya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					check_key_env(t_data *data, char *str, char *str2, \
					char **ptr);
...
int					check_key_export(t_data *data, char *str, char **ptr, \
					char *str3);
void				add_variable_export(t_data *data, char *str);

//	util_export_3
char				*add_double_quotes_once_export(char *str, char *str2, \
					int i, int j);
